...
You can download the [data file](/files/models/chapter_05/ElevationData.txt) with the elevations for the realistic butterfly model from <https://ees4760.jgilligan.org/files/models/chapter_05/ElevationData.txt>
