...
Homework #4 is due today: Railsback & Grimm, Ch. 2, Ex. 3--4. and Ch. 3, Ex. 3. See the homework assignment sheet for details.
...
You can downlload an [ODD for the butterfly model](/files/models/chapter_04/butterfly_model_ODD.txt), which is suitable to paste into the "Info" tab in NetLogo, from the class web site: <https://ees4760.jgilligan.org/files/models/chapter_04/butterfly_model_ODD.txt>
