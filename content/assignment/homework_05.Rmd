...
* **Graduate Students:** For exercise 5.8, you need to answer questions about your models. I recommend that you choose one of the following three ways to answer this:

  1. Write your answers in a file that you upload to Brightspace,
  2. Write your answers on paper and take a picture and upload it as a `.jpg`, `.png`, or `.webp` file,
  3. Edit the "Info" page of your model and put the answer there.
