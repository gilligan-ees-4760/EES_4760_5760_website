...
* The journal article, [V. Grimm _et al._ (2010). "The ODD protocol: A review and first update" _Ecological Modeling_ **221**, 2760--68.](/files/odd/Grimm_2010_ODD_update.pdf). <https://ees4760.jmgilligan.org/files/odd/Grimm_2010_ODD_update.pdf>
* A Word document that provides [a template for writing ODDs](/files/odd/Grimm_2010_odd_template.docx): <https://ees4760.jmgilligan.org/files/odd/Grimm_2010_odd_template.docx>
* Lists of scientific publications using agent-based and individual-based models that either do or don't use the ODD protocol (this appeared as [Appendix 1](/files/odd/Grimm_2010_appendix_1.pdf) of the Grimm _et al._ paper):
  * <https://ees4760.jmgilligan.org/files/odd/Grimm_2010_appendix_1.pdf>, 
  * <https://ees4760.jmgilligan.org/files/odd/ch3_ex1_pubs_with_no_ODD.pdf>, 
  * <https://ees4760.jmgilligan.org/files/odd/ch3_ex2_pubs_with_ODD.pdf>.
