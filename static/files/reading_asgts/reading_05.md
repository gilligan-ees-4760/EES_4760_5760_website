...
You can download an [ODD for the butterfly model](/files/models/chapter_04/ButterflyModelODD.txt), which is suitable to paste into the "Info" tab in NetLogo, from the class web site: <https://ees4760.jmgilligan.org/files/models/chapter_04/ButterflyModelODD.txt>
