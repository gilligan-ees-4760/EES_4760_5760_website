...
to setup
  if maximum-sugar-endowment < minimum-sugar-endowment [
    user-message "Oops: the maximum-sugar-endowment must be at least as large as the minimum-sugar-endowment"
    stop
  ]
  if maximum-metabolism < minimum-metabolism [
    user-message "Oops: the maximum-metabolism must be at least as large as the minimum-metabolism"
    stop
  ]
  clear-all
...
to turtle-setup ;; turtle procedure
  ...
  set metabolism random-in-range minimum-metabolism maximum-metabolism
