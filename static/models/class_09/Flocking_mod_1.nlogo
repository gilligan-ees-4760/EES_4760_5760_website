...
to find-flockmates  ;; turtle procedure
  ifelse six-closest
  [
    set flockmates min-n-of 6 other turtles [distance myself]
  ]
  [
...
* Wilensky, U. (1998).  NetLogo Flocking model.  https://ccl.northwestern.edu/netlogo/models/Flocking.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
...
![CC BY-NC-SA 3.0](https://ccl.northwestern.edu/images/creativecommons/byncsa.png)
...
@#$#@#$#@
<experiments>
  <experiment name="Sensitivity" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    ...
    <steppedValueSet variable="vision" first="2" step="0.5" last="4"/>
    <steppedValueSet variable="max-cohere-turn" first="2" step="0.5" last="4"/>
    ...
    <enumeratedValueSet variable="single-flockmate">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Baseline" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles with [any? flockmates]</metric>
    ...
    <enumeratedValueSet variable="six-closest">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Sensitivity-six" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles with [any? flockmates]</metric>
    ...
    <steppedValueSet variable="vision" first="2" step="0.5" last="6"/>
    <steppedValueSet variable="max-cohere-turn" first="2" step="0.5" last="6"/>
    <enumeratedValueSet variable="max-align-turn">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-separate-turn">
  ...
  <experiment name="Compare Flockmates" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles with [any? flockmates]</metric>
