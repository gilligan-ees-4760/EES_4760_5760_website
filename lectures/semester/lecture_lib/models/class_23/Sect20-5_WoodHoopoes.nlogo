...
@#$#@#$#@
<experiments>
  <experiment name="Calibration" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>year</metric>
    <metric>month</metric>
  ...
  <experiment name="Calibration2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>year</metric>
    <metric>month</metric>
    <metric>count turtles</metric>
    <metric>count patches with [count (turtles-here with [is-alpha?]) &lt; 2]</metric>
    <steppedValueSet variable="scout-prob" first="0.05" step="0.01" last="0.4"/>
