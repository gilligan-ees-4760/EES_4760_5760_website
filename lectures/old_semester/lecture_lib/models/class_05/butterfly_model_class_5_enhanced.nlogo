...
to move  ; The butterfly move procedure, in turtle context
  ...
  ifelse elevation < [elevation] of max-one-of neighbors [elevation]
  [
  ...
  [
    set finished? true ; if the butterfly is at the summit, mark it finished
  ]
...
250
Finished
word (100 * (count turtles with [ finished? ]) / (count turtles)) \"%\"
1
1
11
