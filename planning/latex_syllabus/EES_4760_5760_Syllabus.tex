...
\date{Fall 2026\\ Updated Sept. 12, 2026}
...
I have set up a server at \url{https://ees4760.jmgilligan.org}, where I post the
...
\href{https://ees4760.jmgilligan.org/tools}{Tools} page on the
\href{https://ees4760.jmgilligan.org}{class website}.
...
In conversations with experienced researchers I respect, I see a lot of
disagreement about how useful generative AI tools will be for writing
code for scientific computational models. Moreover, the use of
...
\begin{enumerate}
\item Research suggests that using generative AI tools for writing,
  including writing code actively hurts learning outcomes and critical
  thinking. Be careful that you do not use AI tools as shortcuts that
  will harm your ability to learn the material and gain proficiency
  at computational scientific modeling.

  Many employers, especially in the tech and financial sectors, are
  now reporting that they are changing their hiring practices because so
  many prospective employees who relied on generative AI tools in their
  education cannot do the work, and relying too much on AI tools in your
  studies may harm your career prospects after you graduate.
\item Some experienced scientific model developers report that while
  ...
  produced by AI tools often contains subtle errors that are difficult
  to identify and correct, and the effort of closely reading the code to
  find errors can be greater than the effort of writing the code by
  hand.
\item There is a growing body of research which finds that using
  generative AI tools in writing can subtly change a person's thinking
  and political or moral values, without the writer being aware of it.
  Using AI tools can measurably shift a person's political and moral
  thinking to bring it in line with the hidden biases of the material
  the AI tool was trained on.
\end{enumerate}
...
However, \textbf{I do require that you disclose any use of AI tools.}
If you use
AI tools in your homework or your class projects,
\textbf{you must say what tools you used and how you used them.}
...
\begin{tabular}{l@{~}c@{~}r>{\raggedright}m{2.6in}>{\centering}m{2in}c}
 ...
 \midrule
Thu., & Aug. &  27 & Introduction & No reading &  \\ 
   \midrule
Tue., & Sep. &   1 & The computer modeling cycle & \emph{Railsback \& Grimm\/} Ch.~1, \emph{Smaldino\/} Ch.~1, Handouts (on Brightspace) &  \\ 
   \midrule
Thu., & Sep. &   3 & Introduction to \NetLogo{} & \emph{Railsback \& Grimm\/} Ch.~2, \emph{Smaldino\/} Ch.~2 &  \\ 
   \midrule
Tue., & Sep. &   8 & Specifying models: The ODD protocol & \emph{Railsback \& Grimm\/} Ch.~3 &  \\ 
   \midrule
Thu., & Sep. &  10 & Your first model & \emph{Railsback \& Grimm\/} Ch.~4 &  \\ 
   \midrule
Tue., & Sep. &  15 & Using models for science & \emph{Railsback \& Grimm\/} Ch.~5, \emph{Smaldino\/} Ch.~3 &  \\ 
   \midrule
Thu., & Sep. &  17 & Testing and validating models & \emph{Railsback \& Grimm\/} Ch.~6, Handouts (on Brightspace) &  \\ 
   \midrule
Tue., & Sep. &  22 & Choosing Research Projects & \emph{Railsback \& Grimm\/} Ch.~7 &  \\ 
   \midrule
Thu., & Sep. &  24 & Emergence & \emph{Railsback \& Grimm\/} Ch.~8 &  \\ 
   \midrule
Tue., & Sep. &  29 & Observation & \emph{Railsback \& Grimm\/} Ch.~9 &  \\ 
   \midrule
Thu., & Oct. &   1 & Sensing & \emph{Railsback \& Grimm\/} Ch.~10 &  \\ 
   \midrule
Tue., & Oct. &   6 & Adaptive Behavior and Objectives & \emph{Railsback \& Grimm\/} Ch.~11 &  \\ 
   \midrule
Thu., & Oct. &   8 & Prediction & \emph{Railsback \& Grimm\/} Ch.~12 &  \\ 
   \midrule
Tue., & Oct. &  13 & Interaction & \emph{Railsback \& Grimm\/} Ch.~13, \emph{Smaldino\/} Ch.~6--7, 9 &  \\ 
   \midrule
Thu., & Oct. &  15 & Team Presentations & No reading &  \\ 
   \midrule
Tue., & Oct. &  20 & Discussing Research Projects & No reading &  \\ 
   \midrule
Thu., & Oct. &  22 & \multicolumn{2}{l}{\bfseries\scshape\large Fall Break} & \\% & No reading &  \\ 
   \midrule
Tue., & Oct. &  27 & Scheduling & \emph{Railsback \& Grimm\/} Ch.~14 &  \\ 
   \midrule
Thu., & Oct. &  29 & Stochasticity & \emph{Railsback \& Grimm\/} Ch.~15 &  \\ 
   \midrule
Tue., & Nov. &   3 & Collectives & \emph{Railsback \& Grimm\/} Ch.~16 &  \\ 
   \midrule
Thu., & Nov. &   5 & Patterns & \emph{Railsback \& Grimm\/} Ch.~17--18 &  \\ 
   \midrule
Tue., & Nov. &  10 & Theory Development & \emph{Railsback \& Grimm\/} Ch.~19, \emph{Smaldino\/} Ch.~8 &  \\ 
   \midrule
Thu., & Nov. &  12 & Parameterization and Calibration & \emph{Railsback \& Grimm\/} Ch.~20 &  \\ 
   \midrule
Tue., & Nov. &  17 & Agent-Based Models in Practice & No reading &  \\ 
   \midrule
Thu., & Nov. &  19 & Analyzing ABMs & \emph{Railsback \& Grimm\/} Ch.~22 &  \\ 
   \bottomrule
\end{tabular}
...
\begin{tabular}{l@{~}c@{~}r>{\raggedright}m{2.6in}>{\centering}m{2in}c}
  ...
  \multicolumn{3}{c}{\bfseries Date} & \multicolumn{1}{c}{\bfseries Topic} &\multicolumn{1}{c}{\bfseries Reading} &\\
 \midrule
Tue., & Nov. &  24 & \multicolumn{2}{l}{\multirow{3}{*}{\bfseries\scshape\Large Thanksgiving Break}} & \\% &  &  \\ 
  Thu., & Nov. &  26 &  &  &  \\ 
   \midrule
Tue., & Dec. &   1 & Presentations & No reading &  \\ 
   \midrule
Thu., & Dec. &   3 & Presentations & No reading &  \\ 
   \midrule
Tue., & Dec. &   8 & Sensitivity and Robustness & \emph{Railsback \& Grimm\/} Ch.~23 &  \\ 
   \midrule
Thu., & Dec. &  10 & Looking Ahead: ABMs Beyond this Course & \emph{Railsback \& Grimm\/} Ch.~24, \emph{Smaldino\/} Ch.~10--11 &  \\ 
   \bottomrule
\end{tabular}
