...
\end{verbatim}
  \item
    ...
    so you might have a file \texttt{ex\_5\_4.nlogo} with the model and
    a file \texttt{ex\_5\_4.docx} with the answer to the question about
    that model.
  \item
    ...
    and upload the photo as something like \texttt{ex\_5\_4.jpg}.
  \end{enumerate}
...
\href{https://apps.apple.com/us/app/izip-zip-unzip-unrar-tool/id413971331}{iZip}
for Mac.
...
\item
  ...
  model. Be sure to turn in an answer to the question (you can do this
  in a separate text document or you can edit the ``Info'' tab in
  NetLogo to put your answer at the top of the info page for your model
  by pasting the following in and editing to add your answer.
